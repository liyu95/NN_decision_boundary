...
def model_graph(x, y_):
	...
	with tf.name_scope('fc_2'):
	    #Add the third densely connected layer
	    w_fc2=weight_variable([2000,2000])
	...
	with tf.name_scope('softmax_layer'):
	    w_fc2=weight_variable([2000,y_.get_shape().as_list()[1]])
	    b_fc2=bias_variable([y_.get_shape().as_list()[1]])
	    y_conv_logit=tf.matmul(h_fc1,w_fc2)+b_fc2
